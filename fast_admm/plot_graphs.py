...
cost_df = pd.read_csv('./comparison_costs.csv', header=0)
...
fig = px.box(cost_df[["2 Skills", "4 Skills", "8 Skills"]], points="all", labels={
                     "value": "Guided Solution cost / Optimal cost",
                     "variable": "Guided solutions compared to optimal solutions"
                 },)
...
fig.update_yaxes(range=[1.0, 1.6]) 
fig.show()